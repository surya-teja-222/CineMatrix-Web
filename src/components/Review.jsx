...
export default function Review({ searchTerm }) {
  ...
  return (
    <>
      <div className=" font-Poppins flex w-full flex-col bg-gradient-to-tl from-indigo-900 to-purple-900">
        <h1 className="smm:text-2xl py-4 text-center text-4xl font-extrabold capitalize text-white">
          Thanks for Visiting Us
        </h1>
        <div className="smm:flex-col smm:mx-auto smm:gap-24 my-16 mx-4 flex justify-evenly">
          <div className="group relative flex w-[260px] flex-col gap-4 rounded-2xl bg-[#CD1818] p-6 text-white shadow-none shadow-slate-700 transition-all duration-500 ease-in-out hover:bg-[#ff3939] hover:shadow-2xl">
            <img
              src={gift}
              alt=""
              ...
              draggable="false"
            />
            <h2 className="unselectable mt-[60px] h-24 text-lg font-semibold">
              Did you like our movie recomendation ?
            </h2>
            <p className="unselectable font-light italic">
          ...
          <div className="group relative flex w-[260px] flex-col gap-4 rounded-2xl bg-[#CD1818] p-6 text-white shadow-none shadow-slate-700 transition-all duration-500 ease-in-out hover:bg-[#ff0000] hover:shadow-2xl">
            <img
              src={tree}
              alt=""
              className="absolute  right-0 -top-16 w-[120px] transition-all duration-500 ease-in-out group-hover:scale-[1.3]"
